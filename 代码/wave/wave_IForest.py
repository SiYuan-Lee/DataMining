...
#获取数据集文件所在的目录
path='/Users/mac/Desktop/课程/数据挖掘/wave/benchmarks'
...
for info in files:
    ...
    #取相关属性
    cols=['diff.score','V','V.1','V.2','V.3','V.4','V.5','V.6','V.7','V.8','V.9','V.10','V.11','V.12','V.13','V.14','V.15','V.16','V.17','V.18','V.19','V.20']
    x = data[cols].values
...
print("\nOn Training Data:")
print(sumAuc_train/i)#0.6373834587097327
print("\nOn Test Data:")
print(sumAuc_test/i)#0.6234412345295935